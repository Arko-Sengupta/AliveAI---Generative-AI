...
const BarChart = ({ data, yAxisLabels, xAxisLabels, userValueData, width = 400, height = 300 }) => {
  ...
  useEffect(() => {
    ...
    g.selectAll(".bar")
      ...
      .attr("height", 0)
      .attr("fill", (d) => isHighlighted(d.label, userValueData) ? "#1D9BCE" : "#3DD5F3")
  ...
  return (
    <div className="bar-chart-container" style={{ width: "100%", height: `${height}px`, paddingLeft: "10px" }}>
        ...
        <Row className="dashboard-title-row">
          <Col>
            <h1 className="dashboard-title">
              <FontAwesomeIcon icon={faHouse} style={{ paddingRight: "20px", paddingBottom: "4px", color: "#1880a9", fontSize: "0.75em" }} />
              USER DASHBOARD
            </h1>
          </Col>
        </Row>
        <Row>
          <Col xs={12} lg={6}>
            <Row className="chart-row">
              <Col>
                <BarChart data={barData} yAxisLabels={percentages} xAxisLabels={barXAxisLabels} userValueData={userValueData} />
              </Col>
            </Row>
            <Row className="chart-row">
              <Col>
                <LineChart xAxisLabels={features} yAxisLabels={percentages} lineData1={peopleData} lineData2={userData} xAxisLabel={featureLabel} yAxisLabel={percentageLabel} />
              </Col>
            </Row>
          </Col>
          <Col xs={12} lg={6}>
